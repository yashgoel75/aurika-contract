...
contract Aurika {
    ...
    event Gift(address indexed from, address indexed to, uint256 quantity, uint256 value);
    ...
    function getOrderAt(uint256 index) public view returns (string memory, uint256, uint256) {
